...
internal fun provideSomeStringUseCase(remoteDataSourceRepository: IRemoteDataSourceRepository): BookListUseCase =
    BookListUseCase(remoteDataSourceRepository)